          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="card bg-blue-50 border-blue-200">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-blue-800">How to use your band dashboard</h3>
                  <div className="mt-2 text-sm text-blue-700">
                    <p>• <strong>Rate songs</strong> by clicking the star rating (⭐) - your votes help decide which songs to practice</p>
                    <p>• <strong>Search songs</strong> using the search bar to find specific tracks quickly</p>
                    <p>• <strong>Sort songs</strong> by newest, most voted, alphabetical, or trending</p>
                    <p>• <strong>Add new songs</strong> by clicking "Search Songs" in the sidebar</p>
                    <p>• <strong>View song details</strong> including Spotify previews and album art</p>
                    <p>• <strong>Remove songs</strong> (admin only) using the trash icon if needed</p>
                  </div>
                </div>
              </div>
            </div>
